<ul class="menu-nav">
    ...
    <li class="menu-item {{ Route::is('dashboard.product.*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
        <a href="{{ route('dashboard.product.index') }}" class="menu-link">
            <span class="svg-icon menu-icon">
                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo5/dist/../src/media/svg/icons/Clothes/T-Shirt.svg--><svg
