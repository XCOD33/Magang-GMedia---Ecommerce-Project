...
@section('content')
<form action="{{ route('dashboard.data-master.voucher.store') }}" method="post">
    <div class="card-body">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="discount" class="form-control currency-format"
                    ...
                    value="{{ old('discount') ? number_format(old('discount'),0,',','.') : '' }}">
            </div>
        </div>

        <div class="form-group">
            <label for="expired_at">Kadaluarsa</label>
            <input type="hidden" name="expired_at" value="{{ old('expired_at', date('Y-m-d')) }}">
